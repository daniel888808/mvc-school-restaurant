class orders_do_update extends ActionHandler {
    constructor(module, action, position_id, orders_id) {
        super(module, action);
        this.position_id = position_id;
        this.orders_id = orders_id;
        var form_element = document.getElementById('orders_update_form');
